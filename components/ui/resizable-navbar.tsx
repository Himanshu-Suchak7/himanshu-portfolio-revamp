...
export const NavbarLogo = () => {
	return (
		<a
			href="#"
			className="relative z-20 mr-4 flex items-center space-x-2 px-2 py-1 text-2xl md:text-3xl font-great-vibes text-black dark:text-white hover:opacity-80 transition-opacity"
		>
			Himanshu
		</a>
	);
